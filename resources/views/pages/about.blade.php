@extends ('layouts.app')
     ...
     <div class="container about-container"></div>
         ...
         <ul>
             ...
             <li>Blade templating and assets compilation(" consider myself a pro at this now. Hahaha. Just kidding</li>
             <li>Models and Database migration. Really cool.Gone are the days of making tables using mysql php artisan migrate does the trick. very fast infact</li>
             ...
             <li>How to edit and delete data. Such cute commands like 'delete'. Litt.</li>
             <li>User authentication. My fav part. You know how it always seems like magic when you sign up for a bank account and boom! You have your details presented to you on a dashboard. I know how it works now.</li>
             ...
             <li>File Uploading. I really had fun learning this. How to add a file upload button from laravel collective. How to create unique images with corresponding unique file extensions. How to actually upload a file that a user chooses, displaying a default 'noImage' thumbnail when a user doesn't choose a file. It was so greay to learn.</li>
         </ul>
